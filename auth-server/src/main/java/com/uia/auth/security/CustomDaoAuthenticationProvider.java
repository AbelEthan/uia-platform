...
/**
 * @ClassName: {@link CustomDaoAuthenticationProvider}
 * @Author AbelEthan
 * @Email AbelEthan@126.com
 * @Date 2022/6/16 上午10:41
 * @Description
 */
...
//        }
        ...
        Map<String, Oauth2UserService> userDetailsServiceMap = SpringUtil
                .getBeansOfType(Oauth2UserService.class);

        Optional<Oauth2UserService> optional = userDetailsServiceMap.values().stream()
